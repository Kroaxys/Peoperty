...
Visual Studio 2026 net 10.0 android windows machine krävs för att kunna driva programmet utan fel.

Left click - för att trycka på frågor och sedan för att skriva in ditt svar också.

Poäng rutorna reagerar på att bli tryckta på, sedan kommer också frågan upp längre ner på skärmen. Under frågan finns rutan där du kan skriva in ditt svar. Poäng knappen ligger i botten höger. Den klickar du bara om du har svarat rätt för den lägger till poängen från frågan. Tryck bara ifall du har svarat rätt.
